  ...
  <div class="signup-container">
    <div class="first-step">
      <div class="group">
        ...
        <span class="bar"></span>
        <button
          class="bttn-unite bttn-success check-btn"
          @click="userDuplicateCheck"
        >
          중복체크
        </button>
        <div v-show="idInputFlag">
          ...
          <div
            class="error-msg"
            v-else-if="duplicateCheckFlag == 0"
            style="color: red"
          >
...
export default {
  ...
  methods: {
    ...
    passwordValidation() {
      ...
      // 유효한 PW일때 유효성검사 통과
      this.passwordValidateFlag = pwRule.test(this.formData.userPw)
        ? true
        : false;
    },
    ...
    passwordConfirm() {
      ...
      if (this.passwordValidateFlag) {
        ...
        this.passwordCheckFlag =
          this.formData.userPw == this.formData.userPwConf;
      }
    },
  },
};
...
/* active state */
.first-step .group .my-input:focus ~ label,
